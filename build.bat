...
set LinkerFlags= /incremental:no /opt:icf /opt:ref res.res /subsystem:console /NODEFAULTLIB /STACK:0x100000,0x100000 kernel32.lib ws2_32.lib setupapi.lib bluetoothapis.lib advapi32.lib crypt32.lib
